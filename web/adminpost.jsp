 ...
 <form method="post" action="adminpost_1.jsp"> 
         <table Id="course-table" width="400px" align="center" border=2>
          ...
          <tr><td>Mode of Training </td><td><input type="text" name="mot"></td></tr>
            <tr><td>Batch Type </td><td><input type="text" name="bt"></td></tr>
            <tr><td> Closing date</td><td><input type="text" name="cd"></td></tr>
             <tr><td>Note </td><td><textarea name="nots" rows="4" cols="25"></textarea></td></tr>
